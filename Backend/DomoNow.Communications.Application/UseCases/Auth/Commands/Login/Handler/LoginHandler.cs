...
namespace DomoNow.Communications.Application.UseCases.Auth.Commands.Login.Handler
{
    internal sealed class LoginHandler(IAuthRepository userRepository, IPassword passwordService, IJwtTokenGenerator jwtTokenGenerator) : IRequestHandler<LoginCommand, string>
    {
