...
{
    public class ApiProblemDetailsFactory(ApiBehaviorOptions pApiBehaviorOptions) : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _ApiBehaviorOptions = pApiBehaviorOptions ?? throw new ArgumentNullException(nameof(pApiBehaviorOptions));
